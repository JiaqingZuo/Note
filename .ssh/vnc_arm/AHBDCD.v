...
assign HSEL_S10 = dec[10];   //MEMORY MAP --> 0x4000_0000 to 0x40FF_FFFF  16MB
assign HSEL_S11 = dec[11];   //MEMORY MAP --> 0x4100_0000 to 0x41FF_FFFF  16MB
assign HSEL_S12 = dec[12];   //MEMORY MAP --> 0x4200_0000 to 0x42FF_FFFF  16MB
assign HSEL_S13 = dec[13];   //MEMORY MAP --> 0x4300_0000 to 0x43FF_FFFF  16MB
...
//        MUX_SEL = 4'b1001;
//      end
//    8'h40,8'h41:                      //Img1-----0x2000_0000 to 0x21FF_FFFF  32MB 
//      begin
//        dec = 16'b0000_0100_0000_0000;
//        MUX_SEL = 4'b1010;
//      end
//    8'h42,8'h43:                      //Img2-----0x2200_0000 to 0x23FF_FFFF  32MB 
//      begin
//        dec = 16'b0000_0100_0000_0000;
//        MUX_SEL = 4'b1011;
//      end
//    8'h44,8'h45:                      //Img3-----0x2400_0000 to 0x25FF_FFFF  32MB 
//      begin
//        dec = 16'b0000_1000_0000_0000;
//        MUX_SEL = 4'b1100;
//      end
//    8'h46,8'h47:                      //Imgf-----0x2600_0000 to 0x27FF_FFFF  32MB 
//      begin
//        dec = 16'b0001_0000_0000_0000;
//        MUX_SEL = 4'b1101;
//      end
...
begin
  ...
  case(HADDR[31:28])
    ...
    4'h0,4'h1: 						//MEMORY MAP --> 0x0000_0000 to 0x00FF_FFFF  16MB
      begin
        dec = 16'b0000_0000_00000001;
        MUX_SEL = 4'b0000;
      end
    ...
    4'h4:begin
        case(HADDR[31:24])
            8'h40:                      //Img1-----0x4000_0000 to 0x40FF_FFFF  16MB 
              begin
                dec = 16'b0000_0100_0000_0000;
                MUX_SEL = 4'b1010;
              end
            8'h41:                      //Img2-----0x4100_0000 to 0x41FF_FFFF  16MB 
              begin
                dec = 16'b0000_0100_0000_0000;
                MUX_SEL = 4'b1011;
              end
            8'h42:                      //Img3-----0x4200_0000 to 0x42FF_FFFF  32MB 
              begin
                dec = 16'b0000_1000_0000_0000;
                MUX_SEL = 4'b1100;
              end
            8'h43:                      //Imgf-----0x4300_0000 to 0x43FF_FFFF  32MB 
            begin
              dec = 16'b0001_0000_0000_0000;
              MUX_SEL = 4'b1101;
            end
