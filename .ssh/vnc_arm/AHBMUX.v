...
module AHBMUX(
  ...
  input wire [31:0] HRDATA_S10,
  input wire [31:0] HRDATA_S11,
  input wire [31:0] HRDATA_S12,
  input wire [31:0] HRDATA_S13,
  ...
  input wire HREADYOUT_S10,
  input wire HREADYOUT_S11,
  input wire HREADYOUT_S12,
  input wire HREADYOUT_S13,
  ...
  begin
    case(APHASE_MUX_SEL)
      ...
      4'b1010:begin
        HRDATA = HRDATA_S10;
        HREADY = HREADYOUT_S10;
      end
      4'b1011:begin
        HRDATA = HRDATA_S11;
        HREADY = HREADYOUT_S11;
      end
      4'b1100:begin
        HRDATA = HRDATA_S12;
        HREADY = HREADYOUT_S12;
      end
      4'b1101:begin
        HRDATA = HRDATA_S13;
        HREADY = HREADYOUT_S13;
      end
      default: begin            
        HRDATA = HRDATA_NOMAP;
